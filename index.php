...
<html lang="en">
    <head>
        ...
        <title>Aquaculture Feeding Management Application</title>
        <!-- Favicon-->
        ...
        <link href="assets/css/styles_front.css" rel="stylesheet" />
    ...
    <body id="page-top">
        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" style="background-color: #343957;">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><img src="assets/images/new/Goodstuff-No-Nonsense-Free-Space-Uranus.svg" alt="..." style="min-width: 2.5em; min-height: 2.5em;"/> Aqua Feeding</a>
        ...
        <section class="page-section" id="about">
            <div class="container">
                ...
                <ul class="timeline">
                    <li>
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/images/new/front/pexels-photo-8837715.jpeg" alt="..." /></div>
                    ...
                    <li class="timeline-inverted">
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/images/new/front/pexels-photo-7793675.jpeg" alt="..." /></div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>10 - 13 Nov</h4>
                    ...
                    <li>
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/images/new/front/pexels-photo-57690.jpeg" alt="..." /></div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>14 - 20 Nov</h4>
                    ...
                    <li class="timeline-inverted">
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/images/new/front/pexels-photo-4763078.jpeg" alt="..." /></div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>21 Nov - 18 Dec</h4>
                    ...
                    <li>
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/images/new/front/pexels-photo-10058603.jpeg" alt="..." /></div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>19 - 23 Dec</h4>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center">
                        <p class="large text-muted">ชั้นปีที่ 1 หลักสูตรวิทยาศาสตรมหาบัณฑิต คณะวิทยาศาสตร์ สาขาวิทยาการข้อมูล <br>มหาวิทยาลัยศรีนครินทรวิโรฒ กรุงเทพมหานคร ประเทศไทย</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- Footer-->
        <footer class="footer py-4" style="background-color: #343957; color:#fff">
            <div class="container" >
                <div class="row align-items-center">
                    <div class="col-lg-12 text-lg-start">2021 &copy; Project: Data Management - Palm x Nin - <a href="https://www.swu.ac.th/" style="text-decoration: solid;">@Srinakharinwirot University</a></div>
                </div>
            </div>
        </footer>
        ...
        <!-- Core theme JS-->
        <script src="assets/js/scripts_front.js"></script>
        <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
        <!-- * *                               SB Forms JS                               * *-->
